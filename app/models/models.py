...
class ScheduleUpdate(BaseModel):
    model_config = ConfigDict(extra="forbid")
    # do not allow month_start_date to be updated, delete and recreate if needed
    is_active: bool = True
    notes: str | None = None
...
# USER DATES
# =============================
class UserDateBase(BaseModel):
    user_id: UUID | None = None
    date: datetime.date | None = None

class UserDateCreate(UserDateBase):
    model_config = ConfigDict(extra="forbid")
    # user_date_id is auto-generated by the DB
    user_id: UUID
    date: datetime.date

class UserDateUpdate(UserDateBase):
    model_config = ConfigDict(extra="forbid")
    date: datetime.date | None = None

class UserDateOut(UserDateBase):
    user_date_id: UUID