...
def get_single_user(id: UUID, session: Session = Depends(get_db_session)):
    """Get a user by ID"""
...
def post_user(user: UserCreate, session: Session = Depends(get_db_session)):
    """Create a new user"""
...
def update_user(id: UUID, payload: UserUpdate, session: Session = Depends(get_db_session)):
    """Update a user by ID"""
...
@router.delete("/{id}")
def delete_user(id: UUID, session: Session = Depends(get_db_session)):
    """Delete a user by ID"""
