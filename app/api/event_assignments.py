...
def get_event_assignments_by_event(event_id: UUID, session: Session = Depends(get_db_session)):
...
def update_event_assignment(id: UUID, payload: EventAssignmentUpdate, session: Session = Depends(get_db_session)):
